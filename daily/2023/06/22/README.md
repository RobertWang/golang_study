...
这是一个没有导出任何字段的结构体类型，因此它肯定实现了 [Marshaler 接口](https://docs.studygolang.com/src/time/time.go?s=38148:38191#L1230)。
...
- [Embedding interface in a struct](https://golangbyexample.com/embedding-interfaces-go/#Embedding_interface_in_a_struct)
